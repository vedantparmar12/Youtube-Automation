/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler-prp.jsonc` (hash: a2775426d161212b76c41f1ca3c0cea5)
...
declare namespace Cloudflare {
	interface Env {
		...
		SENTRY_DSN: string;
		NODE_ENV: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/prp-parser-mcp").PRPParserMCP>;
		AI: Ai;
	}
}
